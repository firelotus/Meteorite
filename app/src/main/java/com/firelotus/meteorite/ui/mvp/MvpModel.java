...
public class MvpModel implements IMvpContract.Model {
    ...
    @Override
    public void loadContent(String type, int pageIndex, int pageSize, final /*IMvpContract.Presenter.onContentListener*//*IMvpContract.Presenter.*/ICallBack<ArrayList<GankBean>> onContentListener) {
    ...
    @Override
    public void loadEveryDay(String year, String month, String day, final ICallBack<ArrayList<GankBean>> onContentListener) {
        TreeMap<String, Object> parameters = new TreeMap<>();
        NovateManager.INSTANCE.mGet("day/"+year+"/"+month+"/"+day, parameters, new ICallBack<ResponseBody>() {
            ...
            public void onSusscess(ResponseBody result) {
                try {
                    ...
                    onContentListener.onSusscess(gankBeans);
                } catch (Exception e) {
                    e.printStackTrace();
                    onContentListener.onError();
                }
